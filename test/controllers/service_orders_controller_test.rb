...
class ServiceOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_order" do
    assert_difference('ServiceOrder.count') do
      post service_orders_url, params: { service_order: { description: @service_order.description, final_term: @service_order.final_term, service_type: @service_order.service_type, user_id: @service_order.user_id, user_type: @service_order.user_type } }
    end
  ...
  test "should update service_order" do
    patch service_order_url(@service_order), params: { service_order: { description: @service_order.description, final_term: @service_order.final_term, service_type: @service_order.service_type, user_id: @service_order.user_id, user_type: @service_order.user_type } }
